...
const SettingsModal: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
            <div className="w-[720px] max-w-[90vw] rounded-xl border border-gray-800 bg-gray-900 p-4 space-y-4">
                <div className="text-lg font-semibold">Settings</div>
                <div className="space-y-3">
                    <div className="flex items-center gap-2">
                        <span className="w-36 text-sm text-gray-400">Theme</span>
                        <select
                    ...
                    <div className="flex items-center gap-2">
                        <span className="w-36 text-sm text-gray-400">Show NSFW</span>
                        <input
                            type="checkbox"
                    ...
                    <div className="flex items-center gap-2">
                        <span className="w-36 text-sm text-gray-400">Watch folder</span>
                        <input
                            type="checkbox"
                    ...
                    <div className="flex items-center gap-2">
                        <span className="w-36 text-sm text-gray-400">Thumbnail max</span>
                        <input
                            type="number"
                            className="w-28 px-2 py-1 rounded bg-gray-800 border border-gray-700"
                    ...
                    <div>
                        <span className="block text-sm text-gray-400 mb-1">Ignore patterns (one per line)</span>
                        <textarea
                            className="w-full h-20 px-2 py-1 rounded bg-gray-800 border border-gray-700"
                ...
                <div className="flex justify-end gap-2">
                    <button className="px-3 py-1 rounded bg-gray-800 border border-gray-700" onClick={onClose}>Cancel</button>
